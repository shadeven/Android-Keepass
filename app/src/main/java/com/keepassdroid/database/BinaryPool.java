...
public class BinaryPool {
	...
	public BinaryPool(GroupV4 rootGroup) {
		build(rootGroup);
	}
	...
	private class AddBinaries extends EntryHandler<EntryV4> {

		@Override
		public boolean operate(EntryV4 entry) {
			for (EntryV4 histEntry : entry.history) {
	...
	private void build(GroupV4 rootGroup) {
