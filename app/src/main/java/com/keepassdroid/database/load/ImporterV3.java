...
public class ImporterV3 extends Importer {
   ...
   */
  public KDBV3 openDatabase(InputStream inStream, String password, String keyfile)
   ...
   */
  void readGroupField(KDBV3 db, GroupV3 grp, int fieldType, byte[] buf, int offset)
      throws UnsupportedEncodingException {
    switch (fieldType) {
      case 0x0000:
        // Ignore field
  ...
  void readEntryField(KDBV3 db, EntryV3 ent, byte[] buf, int offset) throws UnsupportedEncodingException {
